...
class _EmailPageState extends State<EmailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                              ...
                              child: Column(children: [
                                ...
                                UtilsWidgetClass().renderGroupActionsButton(
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    secretModel.emails.add(EmailSecret(
          ...
          SizedBox(
              ...
              child: GridView(
                  ...
                  children: [
                    ...
                    for (var i = secretModel.emails.length - 1;
                        i >= 0;
                        i--) ...[
                      Card(
                          child: ListTile(
                          ...
                          IconButton(
                              onPressed: () async {
                                await Clipboard.setData(ClipboardData(
                                    text: secretModel.emails[i].password));
                              },
                        ...
                        onTap: () {
                          TextEditingController _textUserName =
                              TextEditingController()
                                ..text = secretModel.emails[i].username;
                                      ...
                                      child: Column(children: [
                                        ...
                                        UtilsWidgetClass()
                                            .renderGroupActionsButton(context,
                                                () async {
                                          secretModel.emails[i].password =
                                              _textUserPassword.text;
                                          secretModel.emails[i].username =
                                              _textUserName.text;
                        ...
                        subtitle: Text(
                            "Mật khẩu: ${secretModel.emails[i].password}",
                            style: const TextStyle(fontSize: 12)),
                        title: Text(
                            "Tên đăng nhập: ${secretModel.emails[i].username}",
                            style: const TextStyle(fontSize: 12)),
                      )),
                    ],
                  ]))
      ...
      appBar: CustomAppBar(
          backButton: true,
          title: const TitleAppbarWidget(content: "Email Passwords"),
          widgetActions: []),
    );
  }
}
